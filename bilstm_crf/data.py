...
# tags, BIO-mov,per,alb,son
tag2label = {"B-MOV": 0, "B-PER": 1, "B-ALB": 2, "B-ORG": 3, "B-MUI": 4, "I-MOV": 5, "I-PER": 6, "I-ALB": 7, "I-ORG": 8, "I-MUI": 9, "O": 10}
...
if __name__ == '__main__':
    vocab_build('../train_test_data/word2id.pkl', '../trainset.txt', 1)
    with open('../train_test_data/word2id.pkl', 'rb') as fr:
        word2id = pickle.load(fr)
    print('vocab_size:', len(word2id))
