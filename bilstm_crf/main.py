...
from bilstm_crf.utils import str2bool, get_logger, get_entity_keys
from bilstm_crf.data import read_corpus, read_dictionary, tag2label, random_embedding
...
args.mode = "train"
args.batch_size = 50
args.train_data="../trainset.txt"
args.test_data="../testset.txt"
# args.test_data="test_bio_word.txt"
